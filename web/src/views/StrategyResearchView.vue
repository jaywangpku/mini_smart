      ...
      <section v-if="activeTab === 'strategyResearch'" class="research-layout">
        ...
        <section class="main-panel research-panel">
          ...
          <KlineChart
            ...
            :factors="strategyResearchFactors"
